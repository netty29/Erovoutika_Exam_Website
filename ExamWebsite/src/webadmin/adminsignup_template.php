...
<html>
    ...
    <body>
    <div class="container">   
      <img src="images/Logo2light.png" class="logoast" alt="logo">
              ...
              <div class="col-xl-6">
                <div class="card-body p-md-5 text-black">
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        <input type="text" name="clUrUsername" placeholder="Lastname" required>
                      </div>
                    </div>
                    <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        <input type="password" name="clUrPassword" placeholder="Lastname" required>
                      </div>
                    </div>
                  </div>
